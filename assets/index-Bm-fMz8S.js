...
`;const T=document.querySelector("#player_list"),Le=document.querySelector("#all_fill"),Pe=document.querySelector("#all_randomizer"),$e=document.querySelector("#all_delete"),Ce=document.querySelector("#clear_champs"),Te=document.querySelector("#reset_champs"),ke=document.getElementById("champ_list"),$=document.getElementById("champSearch");let B=[],M=[],E=[],N=[],x=[],C=[],g=[],v=[],W=[],X=[],Z=[],ee=[],te=[],ne=[];const q="Session_v1";Le.addEventListener("click",()=>{be(T)});Pe.addEventListener("click",()=>{Q(T,g,M,N,B,!0),L()});$e.addEventListener("click",()=>{Ae(T)});Te.addEventListener("click",()=>{Be()});Ce.addEventListener("click",()=>{He()});$.addEventListener("input",()=>{const e=$.value.toLowerCase();ke.querySelectorAll("li").forEach(n=>{var s,i;const a=((i=(s=n.querySelector("img"))==null?void 0:s.getAttribute("title"))==null?void 0:i.toLowerCase())??"";e&&a.includes(e)?n.classList.add("highlight"):n.classList.remove("highlight")})});function Ie(e){switch(e){case 1:return[...W];case 2:return[...X];case 3:return[...Z];case 4:return[...ee];case 5:return[...te];case 6:return[...ne];default:return console.warn("Non-existing item array type requested:",e),[...v]}}function k(e,t,n){E=[...t],x=[...n],g=[...e]}function ae(){return[E,x,g]}function Me(e){Q(e,g,E,x,B,!1),L()}function y(){const e={users:u,champArrayClosed:g,lanesArrayTeam1Closed:E,lanesArrayTeam2Closed:x};try{localStorage.setItem(q,JSON.stringify(e)),console.info("Session saved!")}catch(t){console.error("Error saving session to localStorage:",t)}}function Ne(){const e=localStorage.getItem(q);if(e)try{const t=JSON.parse(e);return t.users&&Array.isArray(t.users)&&(u.length=0,t.users.forEach(n=>u.push(n))),t.champArrayClosed&&Array.isArray(t.champArrayClosed)?g=t.champArrayClosed:g=[],t.lanesArrayTeam1Closed&&Array.isArray(t.lanesArrayTeam1Closed)?E=t.lanesArrayTeam1Closed:E=[],t.lanesArrayTeam2Closed&&Array.isArray(t.lanesArrayTeam2Closed)?x=t.lanesArrayTeam2Closed:x=[],console.log("Session loaded!"),!0}catch(t){console.error("Error parsing session data from localStorage:",t),localStorage.removeItem(q)}return!1}async function qe(){try{const e=Ne(),[t,n,a,s]=await Promise.all([we("https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/items.json"),Se("https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-summary.json"),Ee(),xe()]);v=t,C=n,C.sort((i,o)=>i.name.localeCompare(o.name)),N=a,M=a,B=s,W=w(v,1),X=w(v,2),Z=w(v,3),ee=w(v,4),te=w(v,5),ne=w(v,6),e||(k(C,M,N),y()),L()}catch(e){console.error("Error loading data:",e)}}qe().then(e=>_(T));function L(){const e=document.querySelector("#champ_list");e.innerHTML="";const t=($==null?void 0:$.value.toLowerCase().trim())||"";C.forEach(n=>{const a=document.createElement("li"),s=t!==""&&n.name.toLowerCase().includes(t),i=g.some(c=>c.id===n.id);a.innerHTML=`
